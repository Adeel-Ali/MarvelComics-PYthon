...
"""
    marvelcomicslib.models.series_list
...
class SeriesList(BaseModel):
    ...
    """Implementation of the 'SeriesList' model.

    TODO: type model description here.

    Attributes:
        available (int): The number of total available series in this list.
            Will always be greater than or equal to the "returned" value.
        collection_uri (string): The path to the full list of series in this
            collection.
        items (list of SeriesSummary): The list of returned series in this
            collection.
        returned (int): The number of series returned in this collection (up
            to 20).
    ...
    def __init__(self, 
                 ...
                 items = None,
                 returned = None):
        """Constructor for the SeriesList class"""
        ...
        if dictionary == None:
            ...
            if dictionary.get("items") != None:
                ...
                for structure in dictionary.get("items"):
                    items.append(SeriesSummary.from_dictionary(structure))
