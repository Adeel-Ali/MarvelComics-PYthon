...
"""
    marvelcomicslib.models.story_data_wrapper
 
    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ) on 09/23/2016
"""
from .story_data_container import StoryDataContainer
from .base_model import BaseModel

class StoryDataWrapper(BaseModel):

    """Implementation of the 'StoryDataWrapper' model.
    ...
    Attributes:
        ...
        data (StoryDataContainer): The results returned by the call.
    ...
    def __init__(self, 
                 ...
                 etag = None,
                 status = None):
        """Constructor for the StoryDataWrapper class"""
    ...
    def from_dictionary(cls, 
        ...
        if dictionary == None:
            ...
            data = StoryDataContainer.from_dictionary(dictionary.get("data")) if dictionary.get("data") else None
