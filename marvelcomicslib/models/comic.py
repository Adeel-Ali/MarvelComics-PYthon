...
from .comic_summary import ComicSummary
from .creator_list import CreatorList
from .comic_date import ComicDate
from .event_list import EventList
from .image import Image
from .comic_price import ComicPrice
...
class Comic(BaseModel):
    ...
    Attributes:
        ...
        urls (list of Url): A set of public web site URLs for the resource.
        ...
        if dictionary == None:
            ...
            if dictionary.get("urls") != None:
                ...
                for structure in dictionary.get("urls"):
                    urls.append(Url.from_dictionary(structure))
