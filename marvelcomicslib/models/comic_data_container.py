...
"""
    marvelcomicslib.models.comic_data_container
...
class ComicDataContainer(BaseModel):

    """Implementation of the 'ComicDataContainer' model.
    ...
    Attributes:
        ...
        offset (int): The requested offset (number of skipped results) of the
            call.
        results (list of Comic): The list of comics returned by the call
    ...
    def __init__(self, 
                 ...
                 results = None,
                 total = None):
        """Constructor for the ComicDataContainer class"""
        ...
        if dictionary == None:
            ...
            if dictionary.get("results") != None:
                ...
                for structure in dictionary.get("results"):
                    results.append(Comic.from_dictionary(structure))
