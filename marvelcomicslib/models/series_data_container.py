...
"""
    marvelcomicslib.models.series_data_container
...
class SeriesDataContainer(BaseModel):

    """Implementation of the 'SeriesDataContainer' model.
    ...
    Attributes:
        ...
        offset (int): The requested offset (number of skipped results) of the
            call.
        results (list of Series): The list of series returned by the call
    ...
    def __init__(self, 
                 ...
                 results = None,
                 total = None):
        """Constructor for the SeriesDataContainer class"""
        ...
        if dictionary == None:
            ...
            if dictionary.get("results") != None:
                ...
                for structure in dictionary.get("results"):
                    results.append(Series.from_dictionary(structure))
