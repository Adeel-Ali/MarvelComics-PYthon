...
"""
    marvelcomicslib.models.creator_list
...
class CreatorList(BaseModel):
    ...
    """Implementation of the 'CreatorList' model.

    TODO: type model description here.

    Attributes:
        available (int): The number of total available creators in this list.
            Will always be greater than or equal to the "returned" value.
        collection_uri (string): The path to the full list of creators in this
            collection.
        items (list of CreatorSummary): The list of returned creators in this
            collection.
        returned (int): The number of creators returned in this collection (up
            to 20).
    ...
    def __init__(self, 
                 ...
                 items = None,
                 returned = None):
        """Constructor for the CreatorList class"""
        ...
        if dictionary == None:
            ...
            if dictionary.get("items") != None:
                ...
                for structure in dictionary.get("items"):
                    items.append(CreatorSummary.from_dictionary(structure))
