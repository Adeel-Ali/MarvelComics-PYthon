...
"""
    marvelcomicslib.models.story_data_container
...
class StoryDataContainer(BaseModel):

    """Implementation of the 'StoryDataContainer' model.
    ...
    Attributes:
        ...
        offset (int): The requested offset (number of skipped results) of the
            call.
        results (list of Story): The list of stories returned by the call
    ...
    def __init__(self, 
                 ...
                 results = None,
                 total = None):
        """Constructor for the StoryDataContainer class"""
        ...
        if dictionary == None:
            ...
            if dictionary.get("results") != None:
                ...
                for structure in dictionary.get("results"):
                    results.append(Story.from_dictionary(structure))
