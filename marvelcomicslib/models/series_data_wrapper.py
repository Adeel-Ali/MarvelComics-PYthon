...
"""
    marvelcomicslib.models.series_data_wrapper
 
    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ) on 09/23/2016
"""
from .series_data_container import SeriesDataContainer
from .base_model import BaseModel

class SeriesDataWrapper(BaseModel):

    """Implementation of the 'SeriesDataWrapper' model.
    ...
    def __init__(self, 
                 ...
                 etag = None,
                 status = None):
        """Constructor for the SeriesDataWrapper class"""
    ...
    def from_dictionary(cls, 
        ...
        if dictionary == None:
            ...
            data = SeriesDataContainer.from_dictionary(dictionary.get("data")) if dictionary.get("data") else None
