...
"""
    marvelcomicslib.models.event_data_container
...
class EventDataContainer(BaseModel):

    """Implementation of the 'EventDataContainer' model.
    ...
    Attributes:
        ...
        offset (int): The requested offset (number of skipped results) of the
            call.
        results (list of Event): The list of events returned by the call
    ...
    def __init__(self, 
                 ...
                 results = None,
                 total = None):
        """Constructor for the EventDataContainer class"""
        ...
        if dictionary == None:
            ...
            if dictionary.get("results") != None:
                ...
                for structure in dictionary.get("results"):
                    results.append(Event.from_dictionary(structure))
