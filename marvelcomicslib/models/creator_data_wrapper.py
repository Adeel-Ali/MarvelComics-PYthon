...
"""
    marvelcomicslib.models.creator_data_wrapper
 
    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ) on 09/23/2016
"""
from .creator_data_container import CreatorDataContainer
from .base_model import BaseModel

class CreatorDataWrapper(BaseModel):

    """Implementation of the 'CreatorDataWrapper' model.
    ...
    def __init__(self, 
                 ...
                 etag = None,
                 status = None):
        """Constructor for the CreatorDataWrapper class"""
    ...
    def from_dictionary(cls, 
        ...
        if dictionary == None:
            ...
            data = CreatorDataContainer.from_dictionary(dictionary.get("data")) if dictionary.get("data") else None
