...
"""
    marvelcomicslib.models.comic_data_wrapper
 
    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ) on 09/23/2016
"""
from .comic_data_container import ComicDataContainer
from .base_model import BaseModel

class ComicDataWrapper(BaseModel):

    """Implementation of the 'ComicDataWrapper' model.
    ...
    def __init__(self, 
                 ...
                 etag = None,
                 status = None):
        """Constructor for the ComicDataWrapper class"""
    ...
    def from_dictionary(cls, 
        ...
        if dictionary == None:
            ...
            data = ComicDataContainer.from_dictionary(dictionary.get("data")) if dictionary.get("data") else None
