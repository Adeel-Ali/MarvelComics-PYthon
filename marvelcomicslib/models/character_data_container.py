...
"""
    marvelcomicslib.models.character_data_container
...
class CharacterDataContainer(BaseModel):

    """Implementation of the 'CharacterDataContainer' model.
    ...
    Attributes:
        ...
        offset (int): The requested offset (number of skipped results) of the
            call.
        results (list of Character): The list of characters returned by the
            call.
    ...
    def __init__(self, 
                 ...
                 results = None,
                 total = None):
        """Constructor for the CharacterDataContainer class"""
        ...
        if dictionary == None:
            ...
            if dictionary.get("results") != None:
                ...
                for structure in dictionary.get("results"):
                    results.append(Character.from_dictionary(structure))
