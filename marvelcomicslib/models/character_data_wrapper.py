...
"""
    marvelcomicslib.models.character_data_wrapper
 
    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ) on 09/23/2016
"""
from .character_data_container import CharacterDataContainer
from .base_model import BaseModel

class CharacterDataWrapper(BaseModel):

    """Implementation of the 'CharacterDataWrapper' model.
    ...
    def __init__(self, 
                 ...
                 etag = None,
                 status = None):
        """Constructor for the CharacterDataWrapper class"""
    ...
    def from_dictionary(cls, 
        ...
        if dictionary == None:
            ...
            data = CharacterDataContainer.from_dictionary(dictionary.get("data")) if dictionary.get("data") else None
