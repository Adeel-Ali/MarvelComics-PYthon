...
"""
    marvelcomicslib.models.event_list
...
class EventList(BaseModel):
    ...
    """Implementation of the 'EventList' model.

    TODO: type model description here.

    Attributes:
        available (int): The number of total available events in this list.
            Will always be greater than or equal to the "returned" value.
        collection_uri (string): The path to the full list of events in this
            collection.
        items (list of EventSummary): The list of returned events in this
            collection.
        returned (int): The number of events returned in this collection (up
            to 20).
        ...
        if dictionary == None:
            ...
            if dictionary.get("items") != None:
                ...
                for structure in dictionary.get("items"):
                    items.append(EventSummary.from_dictionary(structure))
