...
from ..models.creator_data_wrapper import CreatorDataWrapper
...
class SeriesController(BaseController):
    ...
    def get_series_individual(self,
                              series_id):
        """Does a GET request to /series/{seriesId}.
        ...
        _query_builder += '/series/{seriesId}'
        ...
        if _response.status_code == 404:
            raise APIException('404 - Series not found.', _context)
    ...
    def get_series_character_wrapper(self,
                                     ...
                                     order_by = None,
                                     stories = None):
        """Does a GET request to /series/{seriesId}/characters.
        ...
        # Prepare query string for API call
        _query_builder += '/series/{seriesId}/characters'
    ...
    def get_comics_collection_by_series_id(self,
                                           ...
                                           upc = None):
        """Does a GET request to /series/{seriesId}/comics.
        ...
        # Prepare query string for API call
        _query_builder += '/series/{seriesId}/comics'
    ...
    def get_creator_collection_by_series_id(self,
                                            ...
                                            stories = None,
                                            suffix = None):
        """Does a GET request to /series/{seriesId}/creators.
        ...
        # Prepare query string for API call
        _query_builder += '/series/{seriesId}/creators'
    ...
    def get_events_collection_by_series_id(self,
                                           ...
                                           order_by = None,
                                           stories = None):
        """Does a GET request to /series/{seriesId}/events.
        ...
        # Prepare query string for API call
        _query_builder += '/series/{seriesId}/events'
    ...
    def get_series_story_collection(self,
                                    ...
                                    offset = None,
                                    order_by = None):
        """Does a GET request to /series/{seriesId}/stories.
        ...
        # Prepare query string for API call
        _query_builder += '/series/{seriesId}/stories'
