...
class ComicsController(BaseController):
    ...
    def get_comic_individual(self,
                             comic_id):
        """Does a GET request to /comics/{comicId}.
        ...
        if _response.status_code == 404:
            raise APIException('404 - Comic not found.', _context)
    ...
    def get_comic_character_collection(self,
                                       ...
                                       series = None,
                                       stories = None):
        """Does a GET request to /comics/{comicId}/characters.
    ...
    def get_creator_collection_by_comic_id(self,
                                           ...
                                           stories = None,
                                           suffix = None):
        """Does a GET request to /comics/{comicId}/creators.
    ...
    def get_issue_events_collection(self,
                                    ...
                                    series = None,
                                    stories = None):
        """Does a GET request to /comics/{comicId}/events.
    ...
    def get_comic_story_collection_by_comic_id(self,
                                               ...
                                               order_by = None,
                                               series = None):
        """Does a GET request to /comics/{comicId}/stories.
