...
class EventsController(BaseController):
    ...
    def get_event_individual(self,
                             event_id):
        """Does a GET request to /events/{eventId}.
        ...
        if _response.status_code == 404:
            raise APIException('404 - Event not found.', _context)
    ...
    def get_event_character_collection(self,
                                       ...
                                       series = None,
                                       stories = None):
        """Does a GET request to /events/{eventId}/characters.
        ...
        # Prepare query string for API call
        _query_builder += '/events/{eventId}/characters'
    ...
    def get_comics_collection_by_event_id(self,
                                          ...
                                          upc = None):
        """Does a GET request to /events/{eventId}/comics.
        ...
        # Prepare query string for API call
        _query_builder += '/events/{eventId}/comics'
    ...
    def get_creator_collection_by_event_id(self,
                                           ...
                                           stories = None,
                                           suffix = None):
        """Does a GET request to /events/{eventId}/creators.
        ...
        # Prepare query string for API call
        _query_builder += '/events/{eventId}/creators'
    ...
    def get_event_series_collection(self,
                                    ...
                                    title = None,
                                    title_starts_with = None):
        """Does a GET request to /events/{eventId}/series.
        ...
        # Prepare query string for API call
        _query_builder += '/events/{eventId}/series'
    ...
    def get_event_story_collection(self,
                                   ...
                                   order_by = None,
                                   series = None):
        """Does a GET request to /events/{eventId}/stories.
        ...
        # Prepare query string for API call
        _query_builder += '/events/{eventId}/stories'
