...
class CreatorsController(BaseController):
    ...
    def get_creator_individual(self,
                               creator_id):
        """Does a GET request to /creators/{creatorId}.
        ...
        _query_builder += '/creators/{creatorId}'
        ...
        if _response.status_code == 404:
            raise APIException('404 - Creator not found.', _context)
    ...
    def get_comics_collection_by_creator_id(self,
                                            ...
                                            upc = None):
        """Does a GET request to /creators/{creatorId}/comics.
        ...
        # Prepare query string for API call
        _query_builder += '/creators/{creatorId}/comics'
    ...
    def get_creator_events_collection(self,
                                      ...
                                      series = None,
                                      stories = None):
        """Does a GET request to /creators/{creatorId}/events.
        ...
        # Prepare query string for API call
        _query_builder += '/creators/{creatorId}/events'
    ...
    def get_creator_series_collection(self,
                                      ...
                                      title = None,
                                      title_starts_with = None):
        """Does a GET request to /creators/{creatorId}/series.
        ...
        # Prepare query string for API call
        _query_builder += '/creators/{creatorId}/series'
    ...
    def get_creator_story_collection(self,
                                     ...
                                     order_by = None,
                                     series = None):
        """Does a GET request to /creators/{creatorId}/stories.
        ...
        # Prepare query string for API call
        _query_builder += '/creators/{creatorId}/stories'
    ...
    def get_creator_collection(self,
                               ...
                               stories = None,
                               suffix = None):
        """Does a GET request to /creators.
