...
![Add a new project in PyCharm - Step 3](http://apidocs.io/illustration/python?step=createFile&workspaceFolder=MarvelComics-Python&projectName=marvelcomicslib)
...
### <a name="get_series_individual"></a>![Method: ](http://apidocs.io/img/method.png ".SeriesController.get_series_individual") get_series_individual
...
### <a name="get_creator_collection_by_series_id"></a>![Method: ](http://apidocs.io/img/method.png ".SeriesController.get_creator_collection_by_series_id") get_creator_collection_by_series_id
...
### <a name="get_creator_collection_by_comic_id"></a>![Method: ](http://apidocs.io/img/method.png ".ComicsController.get_creator_collection_by_comic_id") get_creator_collection_by_comic_id
...
result = characters_client.get_character_series_collection(character_id, comics, contains, creators, events, limit, modified_since, offset, order_by, series_type, start_year, stories, title, title_starts_with)
...
### <a name="get_character_story_collection"></a>![Method: ](http://apidocs.io/img/method.png ".CharactersController.get_character_story_collection") get_character_story_collection
...
result = characters_client.get_character_story_collection(character_id, comics, creators, events, limit, modified_since, offset, order_by, series)
...
### <a name="get_character_collection"></a>![Method: ](http://apidocs.io/img/method.png ".CharactersController.get_character_collection") get_character_collection
